...
def classify_error(original_eq_text, last_correct_step_text,
    ...
    system = (
        ...
        "(5*4=24, 30/5=-6, 9+12=20, or copying 9 as 8 on the right-hand "
        "side). Use this when the STRUCTURE of the transformation is "
        "correct but a single number is miscomputed or mistyped."
        ...
        "distribution, or who confuses ÷ with −, has not yet understood the "
        "underlying concept."
        "\n\n"
        ...
        "copy slip with a number. DO NOT mention distribution, transposition, "
        "inverse operations or any specific algebraic transformation."
